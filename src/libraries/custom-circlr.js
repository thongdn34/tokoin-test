...
Rotation.prototype.start = function (n) {
  ...
  this.el && (this.el.style.position = 'relative');
  this.el && (this.el.style.width = '100%');
...
Rotation.prototype.show = function (n) {
  ...
  children[this.current] && children[this.current].classList.add('--hide');
  children[n] && children[n].classList.remove('--hide');
...
Rotation.prototype.children = function () {
  var nodes = (this.el && this.el.childNodes) || [];
  var elements = [];
